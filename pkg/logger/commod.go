...
var (
	...
	ErrorConcurrency = AppError{code: 2001, msg: "Concurrent  exception"} // 并发
	...
	ErrorAgentStart      = AppError{code: 3003, msg: "Agent Startr exception"}
	...
	ErrorES = AppError{code: 7001, msg: "Kafka execution exception"} // ES

	ErrorMysql = AppError{code: 8001, msg: "Mysql execution exception"} // mysql
	ErrorRedis = AppError{code: 8002, msg: "Redis execution exception"} // redis
	ErrorCache = AppError{code: 9001, msg: "Mysql execution exception"} // cache

	ErrETCDException = AppError{code: 11111, msg: "ETCD操作异常"} // etcd操作
	// 可扩展...
)
